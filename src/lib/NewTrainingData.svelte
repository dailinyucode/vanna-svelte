<script lang="ts">
    ...
    let options = [
        {
            "name": "DDL",
            "description": "这些是定义数据库结构的创建语句。",
            "example": "CREATE TABLE table_name (column_1 datatype, column_2 datatype, column_3 datatype);"
        },
        {
            "name": "documentation",
            "description": "这可以是任何基于文本的文档。 保持小块并专注于单个主题。",
            "example": "描述你的数据库表结构关系"
        },
        {
            "name": "SQL",
            "description": "这可以是任何正确的 SQL 语句。越多越好。",
    ...
    <div class="mx-auto max-w-2xl">  
      ...
      <div class="mt-5 p-4 relative z-10 bg-white border rounded-xl sm:mt-10 md:p-10 dark:bg-gray-800 dark:border-gray-700">
        <div class="flex justify-between items-center py-3 px-4 border-b dark:border-gray-700 mb-2">
            ...
            <span class="block mb-2 text-sm font-medium dark:text-white">熟练数据类型</span>
          ...
          <div class="mt-2 border-t dark:border-gray-700">
            <label for="hs-feedback-post-comment-textarea-1" class="block mt-2 mb-2 text-sm font-medium dark:text-white">你的 {selectedTrainingDataType}</label>
            <div class="mt-1">
